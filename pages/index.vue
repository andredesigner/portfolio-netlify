  ...
  <div class="page">
    ...
    <main>
      <section class="hero" aria-labelledby="hero-title">
        ...
        <div class="two-coluns align-items-baseline">
      ...
      <section id="projetos" class="cases container" aria-labelledby="cases-title">
        <div id="cases-title" class="cases-title">
          <h2>Projetos <br> selecionados</h2>
        </div>
        <div class="two-coluns cases-list">
          <article v-for="item in caseProjects" :key="item.slug" class="case-item">
            <div class="case-text">
              <p class="case-eyebrow">{{ item.client || item.title }}</p>
              <div>
                <h3 class="case-title">{{ item.title }}</h3>
                <NuxtLink class="text-link" :to="`/projetos/${item.slug}`" aria-label="Ver projeto">
                  Ver projeto
                  <span class="arrow">
                    <IconArrow class="icon" aria-hidden="true" />
                  </span>
      ...
      <section class="identity" aria-labelledby="identity-title">
        <h3 class="case-title">Identidade visual</h3>
...
.hero h1 {
  font-size: clamp(38px, 5.6vw, 104px);
  font-weight: 500;
  line-height: 1.1;
  margin: 0;
}
